$(document).ready(function() {
    ...
    $(".starta-button").on("mouseover", function(e) {
        ...
        $(this).find(".starta-button-hover").css({
            left: relX,
            top: relY
        });
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Track usage time and store in cookie
    ...
    window.addEventListener('beforeunload', function () {
        ...
        // Get existing time spent from cookie
        let totalTime = parseInt(getCookie('timeSpent')) || 0;
        totalTime += timeSpent;

        // Store the updated time spent in the cookie
        setCookie('timeSpent', totalTime, 365); // Cookie expires in 365 days
    });
});
